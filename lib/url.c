...
#define SSLBK_MAX_ALIGN 64
  ...
  size_t offsetsize = sizeof(struct connectdata) % SSLBK_MAX_ALIGN;
  size_t paddingsize = offsetsize ? (SSLBK_MAX_ALIGN - offsetsize) : 0;
  size_t sslbksize = Curl_ssl->sizeof_ssl_backend_data;
  connsize += paddingsize + (4 * sslbksize);
#endif
