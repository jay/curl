...
AC_HELP_STRING([--without-ca-path], [Don't use a default CA path]),
  ...
  ca_warning="warning: not found"
  capath_warning="warning: not found"
  check_capath=""
  try_default_ca_path=""
  ...
  if test "x$want_ca" != "xno" -a "x$want_ca" != "xunset" -a \
    ...
    if test "x$cross_compiling" != "xyes"; then
      ...
      if test "x$want_capath" = "xunset" -a "x$ca" = "xno" -a \
        ...
        try_default_ca_path="/etc/ssl/certs/"
      fi
    else
  ...
  if test "x$capath" != "xno"; then
    check_capath="$capath"
  elif test ! -z "$try_default_ca_path"; then
    check_capath="$try_default_ca_path"
  fi
